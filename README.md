...
- **IA Generativa (DeepSeek):** Integración de modelos de lenguaje mediante **Retrofit** para asistir al usuario en la creación de tarea.
...
- **Seguridad Moderna:** Implementación de **Google Credential Manager API** para un flujo de autenticación seguro.
...
- **Material 3:** Implementación total de las últimas guías de diseño de Google.
...
## 📋 Cómo empezar
1. Configura tu `google-services.json` en la carpeta `app/`.
2. Crea secrets.properties y añade tu API Key de DeepSeek y tu Web Client ID.
